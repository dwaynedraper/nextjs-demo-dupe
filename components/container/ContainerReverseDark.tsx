...
interface ContainerReverseDarkProps {
  className?: string;
 ...
 */
export default function ContainerReverseDark({ children, className="" }: ContainerReverseDarkProps): React.ReactElement {
  return (
    <div className={`bg-brand-dark flex items-center ${className}`}>
